...
const labelStyle = {
  display: 'block', color: '#5a7a99', fontSize: 12,
  marginBottom: 6, fontWeight: 600, letterSpacing: '0.5px',
}

const primaryBtn = (disabled) => ({
  width: '100%', padding: '14px',
  background: disabled ? '#555' : 'linear-gradient(135deg,#00c8ff,#0099cc)',
...
export default function Login() {
  ...
  const handleGoogle = async () => {
    ...
    // If redirecting (Firefox/Safari/Brave), page will reload — just show message
              ...
              <form onSubmit={handleSendOTP}>
                <div style={{ marginBottom: 8 }}>
                  ...
                  <PhoneInput
                    ...
                    inputStyle={{
                      width: '100%', height: '44px', background: '#0a1628',
                      border: '1px solid rgba(0,200,255,0.2)',
                      borderRadius: 8, color: '#e0e0e0',
                      fontSize: '14px', paddingLeft: '48px',
                    }}
                    buttonStyle={{
                      background: '#0a1628',
                      border: '1px solid rgba(0,200,255,0.2)',
                  ...
                  <p style={{ color: '#5a7a99', fontSize: 11, marginTop: 6 }}>
                    Nepal: +977 followed by 10 digits (e.g. +977 9812345678)
                  </p>
                </div>
